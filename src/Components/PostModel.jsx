...
export const PostModelN = ({ movie }) => {
    ...
    return (
        <div className="mx-auto mt-4 min-h-[86vh] max-w-[600px] bg-white text-gray-800 rounded-md border-[2px]
             border-white relative overflow-hidden">
            <LazyLoad offset={100}>
                <img src={movie?.poster_path ? (dynamicUrl + movie?.poster_path) : image404} alt="poster"
            ...
            <article className="ml-2 mt-1 text-left py-3">
                ...
                <div className="flex flex-row items-center gap-2 justify-between  font-semibold">
                    <div className="flex flex-row items-center gap-2 text-base">
                        {liked ? <Icon icon="mdi:like" size={30} color="#080055" z onClick={handleLike} />
                    ...
                    <span className="mr-2 truncate">{movie?.release_date ?? movie?.first_air_date}</span>
                </div>
                ...
                <div className="font-semibold text-sm flex flex-row items-center gap-2">
                    ...
                    <span className="text-sm flex text-gray-500">
                        <Icon icon="mdi:message-star" color="#fd8f00" size={18} />&nbsp;{String(movie?.vote_average ?? 0.0)?.slice(0, 3)}
                    </span>
